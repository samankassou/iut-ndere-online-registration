...
<table style="margin-top: -20px">
    ...
    <p style=" font-size: 13px"><b>Année académique : <?= date('Y') ?>/<?= date('Y')+1 ?></b> <br>
        ...
        <br>
        <h3 style="text-align: center" >CHOIX DE LA MENTION <br><em>MENTION CHOICE</em></h3>
        <hr>
        <table>
        ...
        <table style="width: 700px;" id="second-page-table">
            ...
            <p style="margin-top: 0; padding-top: 0;">Les dossiers complets seront déposés au plus tard le <b>Mercredi 25 Septembre, délai de rigueur</b>, aux lieux ci-après :</p>
            <ul>
            ...
            <p style="margin-top: 0; padding-top: 0;">Les épreuves écrites du concours se dérouleront <b>le mardi 29 et le mercredi 30 Septembre 2020.</b></p>