...
<table style="margin-top: -20px">
    <tr>
        ...
        <td class='text-center'>
            <h3 style="color : black ; font-family: 'Century Gothic';text-align:center; font-size: 15px">
                FICHE DE CANDIDATURE AU CONCOURS<br>
                D'ENTREE AU CYCLE BTS
                <span style="text-align: center;">A <span style="font-size: 20px;"><b>L'IUT</b></span> DE NGAOUNDERE</span>
                <br><em>Candidate's Form For the Entrance Examination to the "BTS"<br>
                Cursus into IUT of Ngaoundere</em>
            </h3>
    ...
    <p style=" font-size: 13px"><b>Année académique : <?= date('Y') ?>/<?= date('Y')+1 ?></b> <br>
        ...
        <h5 style="margin-bottom: 0px; margin-top: 2px;">Cursus des quatre (4) dernières années précédant le concours.</h5><p style="margin-bottom: 4px; margin-top: 0px;"><em>Last four (4) years preceding this entrance examination.</em></p>
        ...
        <br>
        <h3 style="text-align: center" >CHOIX DE LA SPECIALITE <br><em>SPECIALITY CHOICE</em></h3>
        <hr>
        <table>
            <tr><td style="color: black;"><b>Filière choisie: <?= $mention_candidat->nom_mention ?> (<?= $mention_candidat->sigle_mention ?>)</b> <br><em>Chosen mention</em></td></tr>
            <tr><td style="color: black;"><b>Parcours choisis: <?= $parcour_candidat->nom_parcour ?> (<?= $parcour_candidat->abreviation_parcour ?>)</b> <br><em>Chosen majors</em></td></tr>
        </table><br>
        ...
        <table style="width: 700px;" id="second-page-table">
            ...
            <ol style="text-align: justify; font-size: 14px">
                ...
                <li>Différentes attestations d'emploi pour les travailleurs;</li>
            ...
            <h5>IMPORTANT : <em>Les candidats qui préparent le Baccalauréat ou le General Certificate Advanced Level peuvent concourir sous réserve de la présentation de leur diplôme de Baccalauréat ou du GCE/AL</em>.</h5>
            ...
            <p style="margin-top: 0; padding-top: 0;">Les dossiers complets seront déposés au plus tard le <b>Jeudi 15 Octobre 2020, délai de rigueur</b>, aux lieux ci-après :</p>
            <ul>
            ...
            <p style="margin-top: 0; padding-top: 0;">Les épreuves écrites du concours se dérouleront <b>le Samedi 17 Octobre 2020.</b></p>