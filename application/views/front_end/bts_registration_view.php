<div class="container-fluid" style="min-height: 100%">
	<div class="row">
		...
		<div class="container-fluid welcome-zone jumbotron" >
			<h4 class="text-light text-center">Formulaire d'inscription cycle BTS</h4>
		</div>
		<div class="col-sm-3"></div>
		<div class="col-sm-2"></div>
		<div class="col-sm-8 m-auto bg-warning rounded">
			<div id="wizard">
				<form id="form_wizard"class="form" method="post" action="<?= base_url('registration/bts_save_folder') ?>">
					<!-- SECTION 1 -->
					<h4></h4>
					<section>
						<input type="hidden" name="cycle" class="form-control" value="BTS">
						<div class="form-row">
