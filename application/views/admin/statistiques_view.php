        ...
        <div class="card <?= empty($stat_class) ? '' : $stat_class ?>">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <h2 class="mb-2 text-center">Statistiques par centre d'examen et par langue</h2>
                <div class="row">
                  <div class="col-md-6">
                    <!-- AREA CHART -->
                    <div class="card card-secondary">
                      ...
                      <div class="card-body">
                        ...
                        <div id="chart_centre_lang_bts" style="height: 250px; max-width: 100%; margin: 0px auto;"></div>
                      </div>
                      <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card card-secondary">
                      ...
                      <div class="card-body">
                        ...
                        <div id="chart_centre_lang_dut" style="height: 250px; max-width: 100%; margin: 0px auto;"></div>
                      </div>
                      <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
